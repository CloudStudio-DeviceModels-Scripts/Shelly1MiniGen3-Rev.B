...
# Parsing Script – Shelly 1 Mini Gen 3 - Rev. B

This **Parsing** script is designed for the **Shelly 1 Mini Gen 3** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – Shelly 1 Mini Gen 3 Rev. B

Este script de **Parsing** está diseñado para el modelo **Shelly 1 Mini Gen 3** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
